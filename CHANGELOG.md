...
## [2.3.1](https://github.com/ljt20002/-/compare/v2.3.0...v2.3.1) (2026-01-06)

### 🐛 缺陷修复

* **发布流程:** 修复了发布步骤顺序，确立了“先审批、后修改文件”的核心逻辑，确保物理状态变更可控

## [2.3.0](https://github.com/ljt20002/-/compare/v2.2.0...v2.3.0) (2026-01-06)

### ✨ 新功能

* **发布管理:** 技能升级，支持自动生成包含变更摘要的描述性提交信息
* **文档规范:** 强化了跨文件一致性校验与发布诚信准则 (Release Integrity)
