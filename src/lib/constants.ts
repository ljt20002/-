...
export const AVAILABLE_MODELS: ModelInfo[] = [
  ...
  },
  {
    ...
    provider: 'Alibaba',
    inputPrice: '￥0.012 / M tokens',
    outputPrice: '￥0.12 / M tokens',
  },
  {
    ...
    provider: 'DeepSeek',
    inputPrice: '￥6.32 / M tokens',
    outputPrice: '￥18.96 / M tokens',
  },
  {
    id: 'DeepSeek-V3.2',
    name: 'DeepSeek V3.2',
    ...
    provider: 'DeepSeek',
    inputPrice: '￥1.58 / M tokens',
    outputPrice: '￥2.37 / M tokens',
  },
  {
    ...
    provider: 'Mimo',
    inputPrice: '￥0 / M tokens',
    outputPrice: '￥0 / M tokens',
  },
  {
